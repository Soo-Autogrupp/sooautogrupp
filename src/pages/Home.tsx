      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-4">Meie partnerid</h2>
            <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
              Teeme koostööd usaldusväärsete partneritega, et tagada kvaliteetsed varuosad ja teenused.
            </p>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 items-center">
              <a
                href="https://www.vuran.ee/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <img
                  src="https://github.com/Soo-Autogrupp/pildid/blob/main/4x4%20Cruiser.png?raw=true"
                  alt="4x4 Cruiser"
                  className="max-h-16 w-auto object-contain"
                />
              </a>
              ...
              <a
                href="https://controls.is/shop/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow"
              >
                <img
                  src="https://github.com/Soo-Autogrupp/pildid/blob/main/Baldur's.png?raw=true"
                  alt="Baldur's"
                  className="max-h-16 w-auto object-contain"
                />
              </a>
              ...
              <a
                href="https://www.lrhooldus.ee/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow"
              >
                <img
                  src="https://github.com/Soo-Autogrupp/pildid/blob/main/LR%20Hooldus.png?raw=true"
                  alt="LR Hooldus"
                  className="max-h-16 w-auto object-contain"
                />
              </a>
              ...
              <a
                href="https://www.raplamaastur.ee/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow"
              >
                <img
                  src="https://github.com/Soo-Autogrupp/pildid/blob/main/Raplamaastur.png?raw=true"
                  alt="Raplamaastur"
                  className="max-h-16 w-auto object-contain"
                />
              </a>
              ...
              <a
                href="https://www.turbosystems.info/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow"
              >
                <img
                  src="https://github.com/Soo-Autogrupp/pildid/blob/main/Turbo%20Systems.png?raw=true"
                  alt="Turbo Systems"
                  className="max-h-16 w-auto object-contain"
                />
              </a>
              ...
              <a
                href="https://ammeco.ee/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center p-4 bg-gray-900 rounded-lg shadow-sm hover:shadow-md transition-shadow"
              >
                <img
                  src="https://github.com/Soo-Autogrupp/pildid/blob/main/Ammeco%20Auto.png?raw=true"
                  alt="Ammeco Auto"
                  className="max-h-16 w-auto object-contain"
                />
              </a>
              ...
              <a
                href="https://stalla.ee/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center p-4 bg-gray-900 rounded-lg shadow-sm hover:shadow-md transition-shadow"
              >
                <img
                  src="https://github.com/Soo-Autogrupp/pildid/blob/main/Stalla.png?raw=true"
                  alt="Stalla"
                  className="max-h-16 w-auto object-contain"
                />
              </a>

          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <a href="mailto:info@sooautogrupp.com" className="text-sm md:text-base text-blue-600 hover:text-blue-700">info@sooautogrupp.com</a>
              </div>
              
              <div>
                <h3 className="font-semibold mb-1 text-sm md:text-base">Lahtiolekuajad:</h3>
                <p className="text-sm md:text-base">Esmaspäevast reedeni: 8:00 – 16:00</p>
